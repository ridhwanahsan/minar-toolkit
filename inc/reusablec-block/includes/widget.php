 ...
 *
 * Provides a widget for inserting contnet into a widget area. can enable/disable from minar Blocks > Settings
 **/
...
class Reusable_Block extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array( 
			...
			'description' =>  __( 'Insert Minar Blocks.', 'unex-toolkit' ),
	...
	public function form( $instance ) {
        ...
        <select 
        	...
        	<option 
                ...
                <?php echo esc_html__( 'Other post types', 'minar-toolkit' ); ?></option>
        </select></p>
        
        <p class="dynamic_block">
        <label for="<?php echo esc_attr( $this->get_field_id( 'id' ) ); ?>"><?php echo esc_html__( 'Select Block:', 'minar-toolkit' ); ?></label>
		<select
            class="widefat"  
		...
		<?php echo esc_html__( 'Enter post ID:', 'minar-toolkit' ); ?></label><br />
        <input
	...
	public function widget( $args, $instance ) {
		...
		if( ! empty( $instance['id'] ) || ! empty( $instance['othe_id'] ) ){ 
			...
			echo esc_html__( 'No content selected!', 'minar-toolkit' );	
		}
