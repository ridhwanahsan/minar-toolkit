...
class Header_01 extends Widget_Base
{

    public function get_name()
    {
        return 'minar-header-01';
    }

    public function get_title()
    {
        return __('Header One', 'minar-toolkit');
    }
...
$widgets_manager->register(new Header_01());